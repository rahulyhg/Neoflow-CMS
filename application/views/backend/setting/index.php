                ...
                <form method="post" action="<?= generate_url('backend_setting_update'); ?>">
                    ...
                    <div class="form-group row">
                        <div class="offset-sm-3 col-sm-9 <?= has_validation_error('show_custom_css', 'has-danger'); ?>">
                            ...
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" id="checkboxShowCustomCss" class="custom-control-input" value="1" name="show_custom_css" <?= ($setting->show_custom_css ? 'checked' : ''); ?>>
                    ...
                    <div class="form-group row">
                        <div class="offset-sm-3 col-sm-9 <?= has_validation_error('show_custom_js', 'has-danger'); ?>">
                            ...
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" id="checkboxShowCustomJs" class="custom-control-input" value="1" name="show_custom_js" <?= ($setting->show_custom_js ? 'checked' : ''); ?>>
                    ...
                    <div class="form-group row">
                        <div class="offset-sm-3 col-sm-4 <?= has_validation_error('show_debugbar', 'has-danger'); ?>">
                            ...
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" id="checkboxShowDebugbar" class="custom-control-input" value="1" name="show_debugbar" <?= ($setting->show_debugbar ? 'checked' : ''); ?>>
                        ...
                        <div class="col-sm-5 <?= has_validation_error('show_error_details', 'has-danger'); ?>">
                            ...
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" value="1" id="checkboxShowErrorDetails" name="show_error_details" <?= ($setting->show_error_details ? 'checked' : ''); ?>>
