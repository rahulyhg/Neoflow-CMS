        ...
        <ul class="navbar-nav navbar-sidenav">
            ...
            if (has_permission('manage_modules') || has_permission('manage_themes')) {
                ...
                <li class="nav-item<?= is_current_route([
                    ...
                    <a href="#extension-menu" class="nav-link nav-link-collapse<?= is_current_route([
                        'backend_module*',
                        'backend_theme*'
                    ], '', ' collapsed') ?>" data-toggle="collapse">
                        <span class="nav-link-icon">
                    ...
                    <ul id="extension-menu" class="sidenav-second-level collapse<?= is_current_route([
                        'backend_module*',
                        'backend_theme*'
                    ], ' show') ?>">
            ...
            if (has_permission('manage_users') || has_permission('manage_roles')) {
                ...
                <li class="nav-item<?= is_current_route([
                    ...
                    <a href="#account-menu" class="nav-link nav-link-collapse<?= is_current_route([
                        'backend_user*',
                        'backend_role*'
                    ], '', ' collapsed') ?>" data-toggle="collapse">
                        <span class="nav-link-icon">
