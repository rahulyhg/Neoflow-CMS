...
return [
    [
        'routes' => [
            ...
            ['pmod_blog_backend_article_edit', 'get', '/backend/module/blog/(section_id:num)/article/edit/(id:num)', 'Article@edit'],
            ['pmod_blog_backend_article_create', 'post', '/backend/module/blog/article/create', 'Article@create'],
            ['pmod_blog_backend_article_update', 'post', '/backend/module/blog/article/update', 'Article@update'],
            ...
            ['pmod_blog_backend_category_edit', 'get', '/backend/module/blog/(section_id:num)/category/edit/(id:num)', 'Category@edit'],
            ['pmod_blog_backend_category_create', 'post', '/backend/module/blog/category/create', 'Category@create'],
            ['pmod_blog_backend_category_update', 'post', '/backend/module/blog/category/update', 'Category@update'],
            ...
            ['pmod_blog_backend_setting_update', 'post', '/backend/module/blog/(section_id:num)/setting/update', 'Setting@create'],
        ],
