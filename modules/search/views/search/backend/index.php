        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="<?= generate_url('tmod_search_backend_update') ?>" class="form-horizontal">
                    ...
                    <div class="form-group row <?= has_validation_error('url_path', 'is-invalid') ?>">
                        <label for="inputUrlPath" class="col-sm-3 col-form-label">
                            <?= translate('URL path') ?> *
                        </label>
                        <div class="col-sm-9">
                            <input value="<?= $settings->url_path ?>" minlength="3" id="inputUrlPath" type="text" class="form-control" required
                                   name="url_path" maxlength="200"/>
                        </div>
                    </div>
                        ...
                        <div class="offset-sm-3 col-sm-9">
                            ...
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label"
                                       for="checkboxIsActive"><?= translate('The search page is active and accessible') ?></label>
                            </div>
                        </div>
                    </div>
