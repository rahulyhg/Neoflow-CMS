<div class="card">
    <ul class="nav nav-pills flex-column flex-sm-row">
        <li class="nav-item flex-sm-fill text-sm-center">
            <a class="nav-link<?= is_current_route(['backend_navitem_*'], ' active'); ?>" href="<?= generate_url('backend_navitem_index', ['id' => $navigation->id()]); ?>" title="<?= translate('Navigation item', [], true); ?>">
