...
{
    /**
     * Render sections for nestable (drag'n drop list).
     *
     * @param EntityCollection $sections       List of sections
     * @param bool             $showBlockTitle Set FALSE to prevent showing the block title
     *
     * @return string
     */
    public function renderSectionNestable(EntityCollection $sections, bool $showBlockTitle = true): string
    {
        $output = '';
        if ($sections->count()) {
