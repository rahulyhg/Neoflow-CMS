...
class Manager extends AbstractModuleManager
{
    ...
    public function install(): bool
    {
        ...
        $this
            ->database()
            ->prepare('CREATE TABLE `mod_sitemap_urls` (
        ...
        $this
            ->database()
            ->prepare('CREATE TABLE `mod_sitemap_settings` (
        ...
        $setting = Model\SettingModel::create([
    ...
    public function initialize(): bool
    {
        ...
        // Register service
        $this->app()->registerService($service, 'sitemap');
