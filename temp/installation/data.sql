...
INSERT INTO `modules` VALUES(11, 'Search', 'search', 'search', 'tmod_search_backend_index', 'pmod_search_frontend', '\\Neoflow\\Module\\Search\\Manager', 'Jonathan Nessier <jonathan.nessier@neoflow.ch>', 'Provides a dynamic search.', 'Copyright (c) Jonathan Nessier, Neoflow.ch', 'MIT', '1.0.0', 1, 'tool', '', 0);
